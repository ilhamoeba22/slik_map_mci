  ...
  if (!isAuthenticated) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative' }}>
        {/* 3D Hanging Lamp (Top-Center) */}
        <div className={`hanging-lamp ${theme === 'light' ? 'lamp-on' : 'lamp-off'}`}>
          <div className="lamp-wire"></div>
          <div className="lamp-socket">
            <div className="socket-screw-1"></div>
            <div className="socket-screw-2"></div>
          </div>
          <div className="lamp-bulb-body">
            <div className="glass-reflection"></div>
            <div className="lamp-filament-3d"></div>
          </div>
          <div className="lamp-glow-cone"></div>
        </div>
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          background: isCurrent ? 'var(--accent-primary)' : 'rgba(255,255,255,0.02)',
